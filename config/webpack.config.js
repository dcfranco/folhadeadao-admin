...
const themesEntryPoints = Object.keys(themes.entryPoints);
...
module.exports = function(webpackEnv) {
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        // Onidata Alias
        'admin': path.resolve(paths.appSrc, 'app', 'Admin'),
        'seller': path.resolve(paths.appSrc, 'app', 'Seller'),
              ...
              use: [
                {
                  ...
                  options: {
                    extract: true,
                    spriteFilename: "static/media/app-sprite.[hash:8].svg",
                    publicPath: publicPath
                  }
                },
              ]
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          {},
          {
            ...
            excludeChunks: themesEntryPoints
          },
          isEnvProduction
            ? {
                minify: {
      ...
      new ManifestPlugin({
        ...
        generate: (seed, files, entrypoints) => {
          const manifestThemes = themesEntryPoints.reduce((mt, theme) => {
            const ep = entrypoints[theme].filter(
              fileName => !fileName.endsWith('.map') && !fileName.endsWith('.js')
            );
            return {
              ...mt,
              [theme]: `/${ ep[0] }`,
      ...
      isEnvProduction &&
        new WorkboxWebpackPlugin.GenerateSW({
          clientsClaim: true,
          exclude: [/\.map$/, /themes-manifest\.json$/],
