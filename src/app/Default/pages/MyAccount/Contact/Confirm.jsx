...
const MyAccountContactConfirm = ({ handleSubmit, profile: { pages } }) => {
  ...
  const { state: { phone, token } } = location
        ...
        <div className='row'>
          <div className='col-12 col-md-5 offset-md-4 col-lg-4 offset-lg-4'>
            <span className='d-block font-size-lg font-weight-bold mb-3'>
              Para sua segurança, informe sua senha para confirmar a
              validação do seu telefone de contato.
            </span>
            <Field
              name='password'
              id='password'
...
MyAccountContactConfirm.propTypes = {
