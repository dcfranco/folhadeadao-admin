...
const SalesFunnelSidePanel = ({ pages, routes, onChange }) => {
...
SalesFunnelSidePanel.propTypes = {
  routes: PropTypes.object.isRequired,
  pages: PropTypes.object.isRequired,
  onChange: PropTypes.func
}

SalesFunnelSidePanel.defaultProps = {
  onChange: undefined
}

export default React.memo(SalesFunnelSidePanel)
